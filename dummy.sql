...
INSERT INTO `subjective_quiz` (`subjective_quizid`, `subjcode`, `name`, `title`, `intro`, `totalques`, `correct`, `time`, `date`, `testkey`, `teacher_id`) VALUES
(1050324, 'MCS 104', 'IoT and its Application in AI', 'Subjective mtech Demo 1', 'Read the question completely and answer ', 2, 1, 600, '11-02-2021', '2112M', 24),
(1115461, 'BCS 302', 'Mobile Architecture and Programming', 'Subjective btech Demo 1', '', 3, 2, 1200, '03-02-2021', 'demotest', 24),
