...
<div class="container">
  ...
  <h3>1. This is a SUBJECTIVE test.</h3>
  <h3>2. Every question has to be answered subjectively.</h3>
...
<div class="limiter">
  ...
  {
    $p= $_POST["pwd"];
      $query= "select * from subjective_quiz where subjective_quizid='$tid' and testkey='$p'";
  ...
  $arr= array();
  global $arr;
  $sqll=mysqli_query($con,"SELECT * FROM subjective_ques WHERE quizid='$tid' ORDER BY rand()")or die('Error');
  $i=0;
