...
<div class="navbar" id="myTopnav">
    ...
    <a href="fac_subjective_home.php"><i class="fa fa-files-o" aria-hidden="true"></i> Subjective Tests</a>
    <a href="fac_home.php"><i class="fa fa-files-o" aria-hidden="true"></i> Objective Tests </a>
...
function myFunction() {
  ...
  <div class="main">
      <h1>TEACHING AND TEST MODULE</h1>
        <div class = "adminpanel">
          <h2>Welcome to Faculty Panel</h2>
          <p>You can upload learning materials such as assignments and upload test from here.</p>
        </div>
      </div>
