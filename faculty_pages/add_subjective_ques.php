...
if(isset($_POST["add"]))
{
 ...
 //img start cod//e here
	...
	if(in_array($p,$q))
	{
			...
			$query="INSERT INTO subjective_ques VALUES ('$quid','$kon','$que', '$img')";
			...
			{
$query="INSERT INTO subjective_ques VALUES ('$quid','$kon','$que', '')";
$row=mysqli_query($con, $query);
				echo "<script>alert('Question saved')</script>";
...
if($_SESSION["index"]>=$_SESSION['totalq'])
  {
	     echo "<script>window.location.href='view_subjective_tests.php'</script>";
  }
  else
  {
	  $_SESSION["m"]++;
