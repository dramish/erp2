...
<div class = "manageuser">
  ...
  $sno=1;
    ...
    $sql1 = mysqli_query($con,"SELECT * FROM subjective_history AS h INNER JOIN login_student AS s ON h.email=s.email WHERE h.quizid='$tid' ORDER BY s.rollno ");
     ...
     while($row=mysqli_fetch_array($sql1) ) {
      ...
      echo '<tr><td>'.$sno++.'</td><td>'.$rn.'</td><td>'.$n.'</td><td>'.$d.'</td><td><a title="View" href="view_subjective_response_f.php?qid='.$qid.'&hid='.$hid.'"><i>View Response</i></a></td></tr>';
