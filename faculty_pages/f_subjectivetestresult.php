...
<div class = "manageuser">
  ...
  //$n="";
  $idf= $_SESSION['idf'];
    $sql1 = mysqli_query($con,"SELECT * FROM subjective_quiz where teacher_id='$idf'") or die('No Entries');
     ...
     while($row=mysqli_fetch_array($sql1) ) {
      ...
      $sn=$row['name'];
      $tt=$row['title'];
      $var=$row['subjective_quizid'];

      echo '<tr><td>'.$sno++.'</td><td>'.$sc.'</td><td>'.$sn.'</td><td>'.$tt.'</td><td><a title="Click here to view class test result." href="testres_subjectivetestwise.php?tid='.$var.'&t='.$tt.' "><i>Result</i></a></td><td><a title="Click here to view batchwise class test result." href="testres_subjective_batchwise.php?tid='.$var.'&t='.$tt.' "><i>Batchwise Result</i></a></td><td><a title="Click here to view class test feedback." href="view_subjective_test_fb.php?tid='.$var.'&t='.$tt.' "><i>Feedback </i></a></td></tr>';
