...
<div class = "manageuser">
  ...
  //$n="";
  $idf= $_SESSION['idf'];
    $sql1 = mysqli_query($con,"SELECT DISTINCT program , branch , semester from coursedetails WHERE tid='$idf'") or die('No Entries');
     ...
     while($row=mysqli_fetch_array($sql1) ) {
      ...
      echo '<tr><td>'.$sno++.'</td><td>'.$p.'</td><td>'.$b.'</td><td>'.$s.'</td><td><a title="Click here to view attendance." href="fac_main_attendance.php?p='.$p.'&b='.$b.'&s='.$s.' "><i>View</i></a></td></tr>';
