...
{ 
  ...
  $result = mysqli_query($con,"SELECT * FROM subjective_ques WHERE quizid='$var'") or die('Error');
$c=1;
...
while($row = mysqli_fetch_array($result)) {
  ...
  echo '<tr><td>'.$c++.'</td>
  <td>'.$q.'</td>';
  echo '<td><a title="Remove" href="delSubjectiveQues.php?qid='.$qid.'&tid='.$var.'&tname='.$tn.'"><i>Remove</i></a></td><td><a title="Edit" href="editSubjectiveQues.php?qid='.$qid.'&tid='.$var.'&tname='.$tn.'&ques='.$q.'"><i>Edit</i></a></td></tr>';
}
$c=0;
echo '</table></div></div>';
}
