...
<title>Add Subjective Test</title>
</head>
<body>
<a name="top"></a>
    <div class="content">
...
<span class="title1"><b>Enter Subjective Test Details</b></span><br /><br />
...
<input type="number" name="c" placeholder="Enter marks per question" min="1" required>
...
$_SESSION["y"]=$qid;
 ...
 $idf= $_SESSION['idf'];
	...
	$j=1;
	$index=1;
   $query = "INSERT INTO subjective_quiz(subjective_quizid, subjcode, name, title,intro, totalques,correct, time,date,testkey, teacher_id) values ('$qid','$sub_code','$sub_name','$title1','$des','$totalq','$cor', '$time_limit','$d','$pass', '$idf')";
  ...
  if($row > 0)
	...
	$_SESSION['j']=$j;
		$_SESSION['index']=$index;
		  ...
		  echo "<script>window.location.href='add_subjective_ques.php'</script>";
	}
	else
	{
